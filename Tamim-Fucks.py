...
{w}[{b}2{w}] anonfiles.com - anonymous file upload
    ...
    def menu(self):
        ...
        banner()
        print(f"""
{w}{R} TamimFuck {w} SIMPLE ANDROID RANSOMWARE ATTACK
...
{w}[{b}1{w}] Tamim Fucks - TYPE LOCK SCREEN {w}({y} ANDROID 10 {w})
{w}[{b}2{w}] TamimFucks - TYPE FILE ENCRYPTION {w}({y} ANDROID 7.1 {w})
